 ...
 async isConnected(){
  ...
  setSpeedR(speed){
    this.setState({speedR:(speed/255*100).toFixed(0)});
     BluetoothSerial.write("Q"+speed+'\n');
  }

  setSpeedL(speed){
    this.setState({speedL:(speed/255*100).toFixed(0)});
     BluetoothSerial.write("E"+speed+'\n');
...
:
          ...
          <View style={styles.slidersStyle}>
          <View style={styles.slidersStyleL}>

        <Text>Velocità Sinistra: {this.state.speedL} %</Text>


        <Slider
    style={{width: 250, height: 250, transform: [{ rotate: '-90deg' }], translateY:0}}
...
<View style={styles.slidersStyleR}>
